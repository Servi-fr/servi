...
const s = StyleSheet.create({
  ...
  reviews: { fontFamily: font.body, fontSize: 12.5, color: colors.faint },
  city: { fontFamily: font.body, fontSize: 12.5, color: colors.faint, flexShrink: 1 },
  priceFrom: { fontFamily: font.body, fontSize: 11, color: colors.faint },
